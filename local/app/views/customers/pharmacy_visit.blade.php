        ...
        <div class="col-sm-5">
            ...
            <div class="callspart2" style="width: 100%;margin: 0px;">
                ...
                <div class="row toppart">
                    <div class="col-xs-6 cell">Pharmacy</div>
                    <div class="col-xs-6 callspart2cell2"> {{$data['pharmacy']->name}}</div>
                </div>
                <div class="row toppart">
                ...
                <div class="row toppart">
                    <div class="col-xs-6 cell">Class</div>
                    <div class="col-xs-6 callspart2cell2"> {{$data['pharmacy']->class}}</div>
                </div>
                <div class="row toppart">
                ...
                <div class="row toppart">
                    ...
                    <div class="col-xs-6 callspart2cell2"> {{$data['pharmacy']->address}}</div>
                </div>
                <div class="row toppart">
