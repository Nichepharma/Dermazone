...
//                    pr($reader->toArray());
                    ...
                    foreach ($reader->toArray() as $importedItem) {
                        ...
                        }elseif(in_array(strtolower($importedItem['province']), array('central'))) {
                            $provinceId = 1;
                        }elseif(in_array(strtolower($importedItem['province']), array('east', 'eastern', 'eastern region'))) {
                            $provinceId = 5;
                        }elseif(in_array(strtolower($importedItem['province']), array('western', 'western region'))) {
                            $provinceId = 2;
                        } else {
